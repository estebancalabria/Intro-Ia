...
* Generacion Multimedia
    ...
    * Generacion de Imagenes
        * Tips
            ...
            * Flow de Google para unar Nanno Bannana ilimitado
        * LeonardoAI : Tenia varios modelos
            * Texto-A-Imagen
            * Imagen-A-Imagen
        * Ideogram 
          * Imagenes con Texto
...
* Se usan varias herramientas y se integra
  ...
  * Generamos los videos
      * A partir de texto o imagenes
      * Hoy vemos algunos modelos y herramientas
  * Compaginamos con un editor tipo Capcut
