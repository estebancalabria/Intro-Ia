# Clase Seis - 20 de Novienbre 2025

# Repaso

* Generacion de Imagenes
    * Ver el reel del profe :https://www.instagram.com/p/DRSGNZFgafh/
    * Casos de Uso
        * Generacion de Imagenes a partir de texto
        * Generacion de Imagenes a partir de otra imagen
        * Modificar imagenes
        * Imagenes con Texto
        * Imagenes hiper-realistas
    * Herramientas
        * LeornardoIA (https://leonardo.ai/)
        * Microsoft Designer (https://designer.microsoft.com/)
        * Ideogram (https://ideogram.ai/)
        * Nano Banana (Desde gemini)
...
* Salio Gemini 3
* Novedades de Google :
    * https://www.youtube.com/watch?v=3Qp6gkB4fB4 (Gracias Tomas)
    * https://www.youtube.com/watch?v=jZkTDcYSerY

# Generacion de Videos y Presentaciones Profesionales
